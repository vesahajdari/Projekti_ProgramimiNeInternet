...
<body>
    ...
    <main>
      ...
      <a href="#signin"> <i class="fa fa-birthday-cake icons"></i>  Log In</a>
       ...
       <br>
       <h1 style="text-align: center;font-family: papyrus, arial, sans-serif;font-size:400%; color: rgb(235, 119, 173)">Apple Cake</h1>
       <p style="text-align:center;"><img src="FOTO/Desserts/1b.jpg"  alt="Apple cake" class="ImageSpin"></p>
       <br>
       <br>
       ...
       <p id="ingredients"><ins>Ingredients</ins></p>
            ...
            <form name="Ingredients" title="Ingredients"> 
                ...
                <label for="i1"> 1 cup all-purpose flour</label><br>
                <input type="checkbox" id="i2" name="i2" value="soda">
                <label for="i2"> 1 teaspoon baking soda</label><br>
                <input type="checkbox" id="i3" name="i3" value="cinammon">
                <label for="i3"> 1 teaspoon ground cinnamon</label><br>
                <input type="checkbox" id="i4" name="i4" value="baking">
                <label for="i4"> ½ teaspoon salt</label><br>
                <input type="checkbox" id="i5" name="i5" value="salt">
                <label for="i5"> ½  teaspoon salt</label><br>
                <input type="checkbox" id="i6" name="i6" value="sugar">
                <label for="i6">1 egg</label><br>
                <input type="checkbox" id="i7" name="i7" value="sugar">
                <label for="i7">¼ cup vegetable oil</label><br>
                <input type="checkbox" id="i8" name="i8" value="sugar">
                <label for="i8">2 cups peeled and chopped apple</label><br>
                <input type="checkbox" id="i9" name="i9" value="sugar">
                <label for="i9">½ cup chopped walnuts</label><br>
                <input type="checkbox" id="i10" name="i10" value="sugar">
                <label for="i10">½ cup raisins</label><br>
            </form>
<hr>
<dl>
  ...
  <dd>
      <ol>
          <li>Preheat the oven to <mark> 325 degrees</mark>  and grease and flour a fluted tube pan</li>
          <li>Sift flour, baking soda, cinnamon, and salt together in a bowl. Set aside.</li>
          <li>Mix sugar, egg, and oil together in another bowl. Stir in the flour mixture just until combined; fold in apple, walnuts, and raisins.</li>
          <li>Bake in the preheated oven until a toothpick inserted into the cake comes out clean, about 1 hour.</li>
         
      </ol>
  </dd>
</dl>
<?php
$arr = array('This','recipe','is','delicious!');
echo implode(" ",$arr);


$str = "This recipe is delicious!";
print_r (explode(" ",$str));
?> 
<hr>
</main>
